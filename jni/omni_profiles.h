...
static const std::map<std::string, DeviceFingerprint> G_DEVICE_PROFILES = {
    { "Redmi 9", {
        "Xiaomi", "Redmi", "Redmi 9", "lancelot", "lancelot_global", "mt6768", "lancelot", "V12.5.6.0.RJCMIXM",
        "Redmi/lancelot_global/lancelot:11/RP1A.200720.011/V12.5.6.0.RJCMIXM:user/release-keys", "RP1A.200720.011", "release-keys", "user",
        "MOLY.LR12A.R3.MP.V84.P47", "V12.5.6.0.RJCMIXM", "2021-10-05", "11", "mt6768", "mali", "196610", "MT6768", "zygote64_32",
        "Redmi/lancelot_global/lancelot:11/RP1A.200720.011/V12.5.6.0.RJCMIXM:user/release-keys", "RP1A.200720.011",
    ...
    { "POCO X3 Pro", {
        ...
        "MPSS.HI.3.1.c3-00186-SM8150_GEN_PACK-1", "V12.5.3.0.RJUMIXM", "2021-10-01", "11", "msmnile", "adreno", "196610", "SM8150-AC", "zygote64_32",
        "POCO/vayu_global/vayu:11/RKQ1.200826.002/V12.5.3.0.RJUMIXM:user/release-keys", "RKQ1.200826.002",
    ...
    { "Mi 10T", {
        ...
        "MPSS.HI.3.2.c1.1-00085-SM8250_GEN_PACK-1", "V12.5.1.0.RJDMIXM", "2021-07-01", "11", "kona", "adreno", "196610", "SM8250", "zygote64_32",
        "Xiaomi/apollo_global/apollo:11/RKQ1.200826.002/V12.5.1.0.RJDMIXM:user/release-keys", "RKQ1.200826.002",
    ...
    { "Redmi Note 10 Pro", {
        ...
        "MPSS.AT.4.0-00026-SM7150_GEN_PACK-1", "V12.5.4.0.RKGMIXM", "2021-08-01", "11", "atoll", "adreno", "196610", "SM7150-AB", "zygote64_32",
        "Redmi/sweet_global/sweet:11/RKQ1.200826.002/V12.5.4.0.RKGMIXM:user/release-keys", "RKQ1.200826.002",
    ...
    { "Redmi Note 10", {
        ...
        "1630454400", "REL", "0", "Qualcomm", "Adreno (TM) 612", "OpenGL ES 3.2 V@0502.0 (GIT@5f4e5c9, Ia3b7920, 1600000000)", "1080", "2400", "409", 8, 4,
    ...
    { "POCO M3 Pro 5G", {
        ...
        "1625097600", "REL", "0", "ARM", "Mali-G57 MC2", "OpenGL ES 3.2 v1.r21p0-01rel0.a51a0c509f2714d8e5acbde47570a4b2", "1080", "2400", "404", 8, 6,
        39.2266f, 0.0011974f, 34.906586f, 0.001064f, 2000.0f,  // BMA253 (Bosch)
        false, true, false
    } },
    { "POCO X3 NFC", {
        ...
        "1622630400", "REL", "0", "Qualcomm", "Adreno (TM) 618", "OpenGL ES 3.2 V@0502.0 (GIT@5f4e5c9, Ia3b7920, 1600000000)", "1080", "2400", "394", 8, 6,
        78.4532f, 0.0023946f, 34.906586f, 0.001064f, 4912.0f,  // LSM6DSO (ST Micro)
        false, true, false
    } },
    { "Mi 11 Lite", {
        ...
        "1627776000", "REL", "0", "Qualcomm", "Adreno (TM) 618", "OpenGL ES 3.2 V@0502.0 (GIT@5f4e5c9, Ia3b7920, 1600000000)", "1080", "2400", "401", 8, 6,
        78.4532f, 0.0023946f, 34.906586f, 0.001064f, 4912.0f,  // LSM6DSO (ST Micro)
        false, true, false
    } },
    { "Mi 11", {
    ...
    { "Redmi 10X 4G", {
        ...
        "1622505600", "REL", "0", "ARM", "Mali-G52 MC2", "OpenGL ES 3.2 v1.r21p0-01rel0.a51a0c509f2714d8e5acbde47570a4b2", "1080", "2400", "403", 8, 4,
        39.2266f, 0.0011974f, 34.906586f, 0.001064f, 4912.0f,  // BMA4xy (Bosch)
        false, false, false
    } },
    { "POCO F3", {
    ...
    { "OnePlus Nord", {
        ...
        "OnePlus/avicii/OnePlus Nord:11/RKQ1.201022.002/2105101635:user/release-keys", "avicii-user", "builder02.oneplus.com", "builduser",
    ...
    { "OnePlus N10 5G", {
        ...
        "MPSS.VT.5.2-00040-SM6350_GEN_PACK-1", "2104132208", "2021-04-05", "11", "sm6350", "adreno", "196610", "SM6350", "zygote64_32",
        "OnePlus/billie/OnePlus N10 5G:11/RP1A.200720.011/2104132208:user/release-keys", "billie-user", "builder03.oneplus.com", "builduser",
        "1617235200", "REL", "0", "Qualcomm", "Adreno (TM) 619L", "OpenGL ES 3.2 V@0502.0 (GIT@5f4e5c9, Ia3b7920, 1600000000)", "1080", "2400", "405", 8, 6,
        78.4532f, 0.0023946f, 34.906586f, 0.001064f, 4912.0f,  // LSM6DSO (ST Micro)
        false, true, true
    } },
    { "OnePlus 8", {
        ...
        "OnePlus/instantnoodle/OnePlus8:11/RP1A.200720.011/2105100150:user/release-keys", "instantnoodle-user", "builder04.oneplus.com", "builduser",
    ...
    { "Pixel 5", {
        ...
        "google/redfin/redfin:11/RQ3A.210805.001.A1/7474174:user/release-keys", "redfin-user", "abfarm-release-rbe-32-00025", "android-build",
        "1627776000", "REL", "0", "Qualcomm", "Adreno (TM) 620", "OpenGL ES 3.2 V@0502.0 (GIT@5f4e5c9, Ia3b7920, 1600000000)", "1080", "2400", "432", 8, 8,
        78.4532f, 0.0023946f, 34.906586f, 0.001064f, 4912.0f,  // LSM6DSO (ST Micro)
        false, true, false
    } },
    { "Pixel 4a 5G", {
        ...
        "google/bramble_vend/bramble:11/RQ3A.210705.001/7380771:vendor/release-keys", "bramble-user", "abfarm-release-rbe-64.hot.corp.google.com", "android-build",
        "1625616000", "REL", "0", "Qualcomm", "Adreno (TM) 620", "OpenGL ES 3.2 V@0502.0 (GIT@5f4e5c9, Ia3b7920, 1600000000)", "1080", "2400", "413", 8, 6,
        78.4532f, 0.0023946f, 34.906586f, 0.001064f, 4912.0f,  // LSM6DSO (ST Micro)
        false, true, false
    } },
    { "Pixel 4a", {
        ...
        "google/sunfish/sunfish:11/RQ3A.210805.001/7390230:user/release-keys", "sunfish-user", "abfarm-release-rbe-32-00027", "android-build",
        "1627776000", "REL", "0", "Qualcomm", "Adreno (TM) 618", "OpenGL ES 3.2 V@0502.0 (GIT@5f4e5c9, Ia3b7920, 1600000000)", "1080", "2400", "443", 8, 6,
        78.4532f, 0.0023946f, 34.906586f, 0.001064f, 4912.0f,  // LSM6DSO (ST Micro)
        false, true, false
    } },
    { "Pixel 3a XL", {
        ...
        "google/bonito/bonito:11/RP1A.200720.011/6734798:user/release-keys", "bonito-user", "abfarm-release-rbe-32-00010", "android-build",
        "1619827200", "REL", "0", "Qualcomm", "Adreno (TM) 615", "OpenGL ES 3.2 V@0502.0 (GIT@5f4e5c9, Ia3b7920, 1600000000)", "1080", "2400", "400", 8, 4,
        78.4532f, 0.0023946f, 34.906586f, 0.001064f, 4912.0f,  // LSM6DSO (ST Micro)
        false, true, false
    } },
    { "Moto G Power 2021", {
        ...
        "motorola/borneo/borneo:11/RRQ31.Q3-47-22/2b4fae:user/release-keys", "borneo-user", "buildbot-motoauto06.mcd.mot.com", "hudsoncm",
    ...
    { "Moto G Stylus 2021", {
        ...
        "motorola/nairo_retail/nairo:11/RPNS31.Q1-45-20/1.0.0.0:user/release-keys", "nairo_retail-user", "moto-build-prod-02", "moto",
    ...
    { "Moto Edge", {
        ...
        "MPSS.VT.5.2-00075-SM7250_GEN_PACK-1", "1.0.0.0", "2021-04-01", "11", "lito", "adreno", "196610", "SM7250", "zygote64_32",
        "motorola/racer_retail/racer:11/RRAS31.Q1-16-113/1.0.0.0:user/release-keys", "racer_retail-user", "moto-build-prod-03", "moto",
        "1617235200", "REL", "0", "Qualcomm", "Adreno (TM) 620", "OpenGL ES 3.2 V@0502.0 (GIT@5f4e5c9, Ia3b7920, 1600000000)", "1080", "2340", "384", 8, 6,
        78.4532f, 0.0023946f, 34.906586f, 0.001064f, 4912.0f,  // LSM6DSO (ST Micro)
        false, false, false
    } },
    { "Moto Edge Plus", {
        ...
        "1619827200", "REL", "0", "Qualcomm", "Adreno (TM) 650", "OpenGL ES 3.2 V@0502.0 (GIT@5f4e5c9, Ia3b7920, 1600000000)", "1080", "2340", "384", 8, 12,
        78.4532f, 0.0023946f, 34.906586f, 0.001064f, 4912.0f,  // LSM6DSO (ST Micro)
        false, false, false
    } },
    { "Nokia 8.3 5G", {
        ...
        "Nokia/BVUB_00WW/nokia_8.3_5g:11/RKQ1.200928.002/00WW_3_510:user/release-keys", "BVUB_00WW-user", "hmd-build-01", "hmd",
    ...
    { "Nokia 5.4", {
        ...
        "Nokia/CAV_00WW/nokia_5.4:11/RKQ1.200928.002/00WW_2_440:user/release-keys", "CAV_00WW-user", "hmd-build-02", "hmd",
    ...
    { "Realme 8 Pro", {
        ...
        "MPSS.AT.4.0-00050-SM7150_GEN_PACK-1", "1636363205855", "2021-11-01", "11", "atoll", "adreno", "196610", "SM7125", "zygote64_32",
        "realme/RMX3091/RMX3091:11/RP1A.200720.011/1636363205855:user/release-keys", "RMX3091-user", "oppo-build-01", "oppo",
        "1635724800", "REL", "0", "Qualcomm", "Adreno (TM) 618", "OpenGL ES 3.2 V@0502.0 (GIT@5f4e5c9, Ia3b7920, 1600000000)", "1080", "2400", "411", 8, 8,
        39.2266f, 0.0011974f, 34.906586f, 0.001064f, 2000.0f,  // BMA253 (Bosch)
        false, true, false
    } },
    { "Realme GT Master", {
        ...
        "MPSS.VT.5.2-00095-SM7325_GEN_PACK-1", "1638316800000", "2021-12-01", "11", "sm7325", "adreno", "196610", "SM7325", "zygote64_32",
        "realme/RMX3363/RE58B2L1:11/RP1A.200720.011/1638316800000:user/release-keys", "RMX3363-user", "oppo-build-02", "oppo",
        "1638316800", "REL", "0", "Qualcomm", "Adreno (TM) 642L", "OpenGL ES 3.2 V@0502.0 (GIT@5f4e5c9, Ia3b7920, 1600000000)", "1080", "2400", "409", 8, 8,
        39.2266f, 0.0011974f, 34.906586f, 0.001064f, 2000.0f,  // BMA253 (Bosch)
        false, true, false
    } },
    { "ASUS ZenFone 7", {
        ...
        "M3.13.24.51-Sake_0000100", "18.0840.2101.26-0", "2021-09-01", "11", "kona", "adreno", "196610", "SM8250-AB", "zygote64_32",
        "asus/WW_I002D/ASUS_I002D:11/RKQ1.200826.002/18.0840.2101.26-0:user/release-keys", "WW_I002D-user", "android-build", "jenkins",
        "1629859200", "REL", "0", "Qualcomm", "Adreno (TM) 650", "OpenGL ES 3.2 V@0502.0 (GIT@5f4e5c9, Ia3b7920, 1600000000)", "1080", "2400", "394", 8, 8,
        78.4532f, 0.0023946f, 34.906586f, 0.001064f, 4912.0f,  // LSM6DSO (ST Micro)
        false, false, false
    } },
    { "Realme 8", {
        ...
        "MOLY.LR12A.R3.MP.V89.6", "1630454400000", "2021-09-01", "11", "mt6785", "mali", "196610", "MT6785", "zygote64_32",
        "realme/RMX3085/RMX3085:11/RP1A.200720.011/1630454400000:user/release-keys", "RMX3085-user", "oppo-build-03", "oppo",
        "1630454400", "REL", "0", "ARM", "Mali-G76 MC4", "OpenGL ES 3.2 v1.r26p0-01rel0.a51a0c509f2714d8e5acbde47570a4b2", "1080", "2400", "411", 8, 6,
        39.2266f, 0.0011974f, 34.906586f, 0.001064f, 2000.0f,  // BMA253 (Bosch)
        false, true, false
    } },
};
